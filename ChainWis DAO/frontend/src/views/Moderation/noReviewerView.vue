...
.submit-button:hover {
  transform: translateY(-2px);
  box-shadow: 0 6px 15px rgba(20, 177, 255, 0.4);
...
.reviewer-application-modal {
  ...
  display: flex;
  flex-direction: column;
  border: 1px solid rgba(20, 177, 255, 0.2);
  box-shadow: 0 10px 25px rgba(20, 177, 255, 0.1);
...
.modal-header {
  ...
  margin-bottom: 1.5rem;
  padding-bottom: 1rem;
  border-bottom: 1px solid rgba(20, 177, 255, 0.2);
}
...
.textarea-field {
  width: 100%;
  min-height: 110px;
  border: 1px solid rgba(20, 177, 255, 0.3);
  border-radius: 10px;
  padding: 1rem;
  font-size: 1rem;
  background-color: rgba(255, 255, 255, 0.8);
...
.textarea-field:focus {
  outline: none;
  border-color: #14b1ff;
  box-shadow: 0 0 0 2px rgba(20, 177, 255, 0.1);
  background-color: white;
}

.textarea-field:hover {
  border-color: rgba(20, 177, 255, 0.5);
}
